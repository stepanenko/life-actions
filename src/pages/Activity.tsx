...
import { calculateStreak, getDayName, getDayNum, getDemoHabits, getLocalDateString, getStep } from "./Activity/Activity.helpers"
import type { CATEGORIES } from "./Activity/Activity.constants"

export function ActivityPage() {
  const [habits, setHabits] = useState<Habit[]>([])
  const [newHabitName, setNewHabitName] = useState('')
  const [newHabitCategory, setNewHabitCategory] = useState<keyof typeof CATEGORIES>('health')
  ...
  return (
    <main className="page-wrap px-4 pb-14 pt-8">
      ...
      <HabitHistoryCalendar
        habit={selectedHistoryHabit ?? habits[0]}
        isOpen={Boolean(selectedHistoryHabit)}
          ...
          habits.map((habit) => {
            ...
            return (
              <HabitCard
                ...
                onViewHistory={(selectedHabit) => setSelectedHistoryHabit(selectedHabit)}
